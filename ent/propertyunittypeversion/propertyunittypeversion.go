...
const (
	// Label holds the string label denoting the propertyunittypeversion type in the database.
	Label = "property_unit_type_version"
	...
	// FieldUnitTypeKey holds the string denoting the unit_type_key field in the database.
	FieldUnitTypeKey = "unit_type_key"
	// Table holds the table name of the propertyunittypeversion in the database.
	Table = "property_unit_type_version"
)

// Columns holds all SQL columns for propertyunittypeversion fields.
var Columns = []string{
	FieldID,
	FieldValidFrom,
	FieldValidTo,
...
func ChangeTypeValidator(ct ChangeType) error {
	...
	case ChangeTypeInsert, ChangeTypeUpdate, ChangeTypeDelete:
		return nil
	default:
		return fmt.Errorf("propertyunittypeversion: invalid enum value for change_type field: %q", ct)
	}
}

// OrderOption defines the ordering options for the PropertyUnitTypeVersion queries.
...
// ByUnitTypeKey orders the results by the unit_type_key field.
func ByUnitTypeKey(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldUnitTypeKey, opts...).ToFunc()
}
