...
func checkColumn(t, c string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			...
			attachmentjob.Table:           attachmentjob.ValidColumn,
			lookup.Table:                  lookup.ValidColumn,
			media.Table:                   media.ValidColumn,
			mediaversion.Table:            mediaversion.ValidColumn,
			member.Table:                  member.ValidColumn,
			memberversion.Table:           memberversion.ValidColumn,
			office.Table:                  office.ValidColumn,
			officeversion.Table:           officeversion.ValidColumn,
			openhouse.Table:               openhouse.ValidColumn,
			openhouseversion.Table:        openhouseversion.ValidColumn,
			processorcursor.Table:         processorcursor.ValidColumn,
			property.Table:                property.ValidColumn,
			propertyroom.Table:            propertyroom.ValidColumn,
			propertyroomversion.Table:     propertyroomversion.ValidColumn,
			propertyunittype.Table:        propertyunittype.ValidColumn,
			propertyunittypeversion.Table: propertyunittypeversion.ValidColumn,
			propertyversion.Table:         propertyversion.ValidColumn,
			rawoutput.Table:               rawoutput.ValidColumn,
